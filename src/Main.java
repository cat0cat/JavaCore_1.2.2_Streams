...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        List <String> recruit = persons.stream().filter(person -> person.getSex() == Sex.MAN)
        ...
        Collection<Person> ableToWork = persons.stream().filter(person -> (person.getEducation() == Education.HIGHER))
